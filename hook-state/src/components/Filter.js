            ...
            <div className=''>
                <form onSubmit={handleAddFilm} className='flex flex-row justify-evenly'>
                    <div class="mb-6">
                        ...
                        <input type="text" name="titre" placeholder="Title" value={nouveauFilm.titre} onChange={handleInputChange} id="large-input" class="block w-auto p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                    </div>
                    <div class="mb-6">
                        <label for="base-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Rating</label>
                        <input type="text" name="note" placeholder="Note" value={nouveauFilm.note} onChange={handleInputChange} id="base-input" class="bg-gray-50 border p-2 w-auto border-gray-300 border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                    </div>
                    <div className='mb-6'>
                        <label for="small-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Url Image</label>
                        <input type="text" name="poste" placeholder="URL de l'image" value={nouveauFilm.poste} onChange={handleInputChange} id="small-input" class="block w-auto p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                    </div>
